...
// ===== v8z4b32E9G — side width handles (Text Asset apenas) =====
// A E9G é uma EXCEÇÃO deliberada e ESPECÍFICA para Text Asset ao invariante REG-028
...
// Invariante central (E9G): width drag nunca escala — fontSize/textBaseFontSize nunca
