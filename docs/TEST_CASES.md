...
## TC-070 — Moldura transitória temporal do Play de Frames (E9AQ/E9AU / REG-069)
...
- Evidência automatizada: contrato estático e smoke WebKit mobile E9AQ/E9AU em `tests/smoke/app.spec.mjs`. Validação física obrigatória em iPhone/Safari antes de merge.
