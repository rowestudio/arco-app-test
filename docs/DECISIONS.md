...
- **Status:** ativa; implementada e automatizada (gate `E9G —` em `tests/smoke/app.spec.mjs`, TC-054), **validação física pendente** (iPhone/Safari, Roberto). Nenhuma promoção autorizada.
