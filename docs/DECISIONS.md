...
- **Status:** ativa; implementada e automatizada (dois gates `REG-055 —`), **validação física pendente** (iPhone/Safari, Roberto — terceira tentativa após duas reprovações). Nenhuma promoção autorizada.
- **Documento relacionado:** `docs/REGRESSIONS.md` (REG-055), `docs/PRODUCT_RULES.md` (regra canônica), `docs/TEST_CASES.md`, `docs/PROJECT_STATE.md`.
