...
- **Prevenção:** mutações usam disparadores explícitos, inclusive a conclusão de escala/rotação pelos quatro controles reais de canto do Frame; Play e toque sem transformação não criam revisão; barreira central adia autosave normal durante Preview/Export e retoma uma única revisão pendente após saída normal, erro de preparação/cleanup, troca de imagem ou reset; flush de ocultação/saída permanece prioritário.
