...
| REG-046 | Frame, câmera e geometria visual derivada de Parallax divergem ou conservam cache de outro Frame. | O enquadramento do Stage deixa de representar a câmera usada por Preview/Export. | Frame/Câmera/Parallax | Comparar numericamente câmera e retângulos por asset em depth 0, positivo e negativo; repetir A → B → C → A e mutar a geometria do Frame ativo. | Smoke WebKit E8W compara geometria real e invariantes canônicos, sem depender somente de flags. | automatizado; Safari real pendente |
